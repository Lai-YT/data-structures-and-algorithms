...
class BinarySearchTreeTestCase(unittest.TestCase):
    ...
    def test_size_1(self) -> None:
        ...
        self._bst.insert(35)
        self.assertEqual(1, self._bst.size())
        self._bst.insert(45)
        self.assertEqual(2, self._bst.size())
        self._bst.insert(40)
        self.assertEqual(3, self._bst.size())
        self._bst.insert(43)
        self.assertEqual(4, self._bst.size())
        self._bst.insert(41)
        self.assertEqual(5, self._bst.size())
        self._bst.insert(42)
        self.assertEqual(6, self._bst.size())
